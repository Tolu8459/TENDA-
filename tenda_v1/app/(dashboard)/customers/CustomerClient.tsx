...
export default function CustomersClient(/*{customers,}:{customers:Customer[];}*/){
    ...
    return(
        <div className="w-full">
            ...
            <div  className=" h-18 mr-8 ml-4 flex flex-1 items-center  text-black border-b-1 border-b-gray-400 flex flex-row justify-between mt-4">
          ...
          {/* {customers.map((c)=>(
                <div key={c.id} className=" h-16 mr-8 ml-4 flex flex-1 items-center  text-black border-b-1 border-b-gray-400 flex flex-row justify-between">
                <div>
                    <p>{c.name}</p>
                    <p>{c.phone_number}</p>
                    <p>{c.email}</p>
